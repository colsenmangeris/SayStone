...
task_test_dir=$(mktemp -d /tmp/fluidvoice-shared-pipeline-tests.XXXXXX)
...
xcrun swiftc -O \
    ...
    "$task_repo_dir/Tests/SharedDictationPipelineTests.swift" \
    -o "$task_test_dir/shared-pipeline-tests"
"$task_test_dir/shared-pipeline-tests"
